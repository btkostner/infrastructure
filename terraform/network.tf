...
resource "nomad_volume" "caddy_internal_data" {
  volume_id             = "caddy-internal-data"
  name                  = "caddy-internal-data"
  namespace             = "network"
  type                  = "csi"
  external_id           = "caddy-internal-data"
  ...
  context = {
    ...
    iqn = "iqn.2000-01.com.synology:Behemoth.caddy-internal-data"
    lun = "1"
  }
